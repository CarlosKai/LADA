...
# file_path = '../../data/HHAR_SA/train_1.pt'
#
...
# 加载数据
file_path = '../../data/EEG/train_1.pt'  # 替换为你的文件路径
...
for i in range(min(100, len(samples))):  # 确保不会超过样本数量
    ...
    plt.plot(sample[1100:1900, 0], linestyle='-', color='#5095C4', linewidth=2.5)
    ...
    ax.spines['bottom'].set_visible(False)  # 底部边框
